...
function generate_Schwinger_data(m_over_g_list, x_list, N, D, accuracy, lambda, l_0, max_sweep_number)

    file = open("observables_$(N)_$(D).txt", "a")
    fid = h5open("mps_$(N)_$(D).h5", "cw")
