...
function h5_to_mps(N::Int64, D::Int64, mg::Float64, x::Float64)::Vector{Array{ComplexF64}}
    ...
    mps = the mps saved in the h5 file with the name "/lustre/fs23/group/nic/tangelides/Schwinger Wilson MPS Data/$(N)_$(x)_$(D)/mps_$(N)_$(D)_$(mg)_$(x).h5"
    """

    name_of_file = "/lustre/fs23/group/nic/tangelides/Schwinger Wilson MPS Data/$(N)_$(x)_$(D)/mps_$(N)_$(D)_$(mg)_$(x).h5"
