...
function get_updated_site(L::Array{ComplexF64}, W::Array{ComplexF64}, R::Array{ComplexF64})::Tuple{Array{ComplexF64}, ComplexF64}
    ...
    E, M = eigsolve(Heff, 1, :SR, ishermitian = true, krylovdim = 100) # 1 means how many evals to get, :SR means smallest real to get the eval with the smallest real part, also note M'*M = 1.0+0.0im
